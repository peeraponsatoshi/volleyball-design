<template>
  <div class="text-style-panel">
    ...
    <el-row class="mt-10">
      <el-col :span="6">
        <el-tooltip placement="top" :content="t('message.textColor')" :hide-after="0" >
      ...
      <el-col :span="6">
        <el-tooltip placement="top" :content="t('style.bgColor')" :hide-after="0">
          <div @click.stop class="tooltip-popover">
      ...
      <el-col :span="12">
        <el-button-group class="full-group">
          <el-tooltip placement="top" :content="t('style.increaseFontSize')" :hide-after="0">
            <el-button class="font-size" @click="handleElementFontsize('+')">
              <IconFontSize />+
            </el-button>
          </el-tooltip>

          <el-tooltip placement="top" :content="t('style.decreaseFontSize')" :hide-after="0">
    ...
    <el-row class="mt-10">
      <div class="full-checkbox">
        <el-tooltip placement="top" :content="t('style.bold')" :hide-after="0">
          <el-checkbox-button :value="hasFontWeight" @change="handleElementBlod()">
            <IconTextBold />
          </el-checkbox-button>
        </el-tooltip>
        <el-tooltip placement="top" :content="t('style.italic')" :hide-after="0">
          <el-checkbox-button v-model="hasFontStyle" @change="handleElementItalic()">
            <IconTextItalic />
          </el-checkbox-button>
        </el-tooltip>
        <el-tooltip placement="top" :content="t('style.underline')" :hide-after="0">
          <el-checkbox-button v-model="hasUnderline" @change="handleElementUnderline()">
            <IconTextUnderline />
          </el-checkbox-button>
        </el-tooltip>
        <el-tooltip placement="top" :content="t('style.strikethrough')" :hide-after="0">
    ...
    <el-row class="mt-10">
      <el-button-group class="full-group">
        <el-tooltip placement="top" :content="t('message.transverse')" :hide-after="0">
          <el-button @click="handleElementArrange(false)" :type="elementGrapheme ? 'primary': ''">
            <IconTextRotationNone />
          </el-button>
        </el-tooltip>
        <el-tooltip placement="top" :content="t('message.direction')" :hide-after="0">
          <el-button @click="handleElementArrange(true)" :type="!elementGrapheme ? 'primary': ''">
            <IconTextRotationDown />
          </el-button>
        </el-tooltip>
        <el-tooltip placement="top" :content="t('style.decreaseIndent')" :hide-after="0">
          <el-button @click="handleElementCharSpacing('-')">
            <IconIndentLeft />
          </el-button>
        </el-tooltip>
        <el-tooltip placement="top" :content="t('style.increaseIndent')" :hide-after="0">
          <el-button @click="handleElementCharSpacing('+')">
            <IconIndentRight />
          </el-button>
        </el-tooltip>
    ...
    <el-row class="mt-10">
      <el-col :span="24">
        <el-radio-group class="full-ratio" v-model="textAlign" @change="handleTextAlign">
          <el-tooltip placement="top" :content="t('style.leftAlign')" :hide-after="0">
            <el-radio-button value="justify-left">
              <IconAlignTextLeft />
            </el-radio-button>
          </el-tooltip>
          <el-tooltip placement="top" :content="t('style.center')" :hide-after="0">
            <el-radio-button value="justify-center">
              <IconAlignTextCenter />
            </el-radio-button>
          </el-tooltip>
          <el-tooltip placement="top" :content="t('style.rightAlign')" :hide-after="0">
            <el-radio-button value="justify-right">
              <IconAlignTextRight />
            </el-radio-button>
          </el-tooltip>
          <el-tooltip placement="top" :content="t('message.justifyAlign')" :hide-after="0">
    ...
    <el-row class="mt-10">
      <el-col :span="12">
        <el-tooltip placement="top" :content="t('message.convertToPath')" :hide-after="0">
      ...
      <el-col :span="12">
        <el-tooltip placement="top" :content="t('message.deform')" :hide-after="0">
    ...
    <el-row class="mt-10" v-show="handleElement.type.toLowerCase() === ElementNames.ARCTEXT">
      <el-col :span="4" class="flex-align">
        <el-radio-group class="full-ratio" v-model="(handleElement as ArcText).showCurvature" @change="changeArcTextStatus">
          <el-tooltip placement="top" :content="t('message.hideCurve')" :hide-after="0" v-if="(handleElement as ArcText).showCurvature">
            <el-radio-button :value="false">
              <IconPreviewClose />
            </el-radio-button>
          </el-tooltip>
          <el-tooltip placement="top" :content="t('message.showCurve')" :hide-after="0" v-else>
    ...
    <div class="row">
      <div style="flex: 2;">ระยะบรรทัด：</div>
      ...
      <div style="flex: 2;">ระยะตัวอักษร：</div>
