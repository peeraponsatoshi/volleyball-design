  ...
  >
    <el-row class="thumb-handle items-center">
      <el-col :span="12" class="flex justify-center text-[16px]">
        <div>
          <el-button text ref="menuRef">{{ t('message.files') }}</el-button>
...
const contextmenusThumbnailItem = (): ContextMenu[] => {
  return [
    ...
    {
      text: t('message.paste'),
      subText: 'Ctrl + V',
      handler: pasteTemplate,
    },
    {
      text: t('message.selectAll'),
      subText: 'Ctrl + A',
    },
    { divider: true },
    {
      text: t('message.newPage'),
      subText: 'Enter',
      handler: createTemplate,
    },
    {
      text: t('message.copyPage'),
      subText: 'Ctrl + D',
    },
    {
      text: t('message.deletePage'),
      subText: 'Delete',
      handler: () => deleteTemplate(),
    },
    { divider: true },
    {
      text: t('message.previewFromHere'),
      subText: 'Shift + F5',
    },
  ]
}
